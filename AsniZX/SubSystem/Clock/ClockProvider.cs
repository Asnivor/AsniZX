...
namespace AsniZX.SubSystem.Clock
{
    ...
    public class ClockProvider : IProvider
    {
        ...
        {
            long perfValue;
            QueryPerformanceCounter(out perfValue);
            return perfValue;
        }
        ...
        public ZXBase Spec { get; private set; }

        public void OnAttached(ZXBase spec)
        {
            Spec = spec;
        }
    }
