...
namespace AsniZX.SubSystem.Sound
{
    public class Sound : IDisposable
    {
        ...
        public Sound(ZXForm form)
        {
            // Choose the type of sound output - at the moment there is only XAudio2
        ...
        internal void HandleInitializationOrUnderrun(bool isUnderrun, ref int samplesNeeded)
        {
            ...
            int samplesPerFrame = 885; // Global.SoundSamplesPerFrame; //(int)Math.Round(SampleRate / (double)Global.Emulator.VsyncRate());
