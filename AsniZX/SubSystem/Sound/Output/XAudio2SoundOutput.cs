...
namespace AsniZX.SubSystem.Sound
{
    public class XAudio2SoundOutput : ISoundOutput
    {
        ...
        public void ApplyVolumeSettings(double volume)
        {
            ...
            float[] fls = new float[1];
            fls[0] = (float)volume;
            _sourceVoice.SetChannelVolumes(Sound.ChannelCount, fls);
        }
        ...
        public void StartSound()
        {
            ...
            var format = new XWaveFormat(WaveFormatEncoding.Pcm, Sound.ChannelCount, Sound.SampleRate, (Sound.SampleRate * Sound.BlockAlign)
                , Sound.BlockAlign, (Sound.BytesPerSample * 8));
        ...
        public void WriteSamples(short[] samples, int sampleCount)
        {
            ...
            _sourceVoice.SubmitSourceBuffer(new AudioBuffer(buffer.DataStream), null);
            /*
            {
        ...
        private class BufferPool : IDisposable
        {
            ...
            public class BufferPoolItem
            {
                ...
                public BufferPoolItem(int length)
                {
                    ...
                    DataStream = new DataStream(Bytes.Length, true, false);
                }
            }
        }
    }

    public class XWaveFormat : WaveFormat
    {
        public XWaveFormat(
            WaveFormatEncoding _waveFormatTag,
            short _channels,
            int _sampleRate,
        ...
        {
            waveFormatTag = _waveFormatTag;
            channels = _channels;
            sampleRate = _sampleRate;
            averageBytesPerSecond = _averageBytesPerSecond;
